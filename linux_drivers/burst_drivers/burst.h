...
#define CONTROL_ADDR        CONTROL_ADDR_BASE + 0x0
#define BURST_LENGTH_ADDR   CONTROL_ADDR_BASE + 0x10
#define LOAD_TREES_ADDR     CONTROL_ADDR_BASE + 0x18
#define TREES_USED_ADDR     CONTROL_ADDR_BASE + 0x20
#define PING_PONG_ADDR      CONTROL_ADDR_BASE + 0x28
