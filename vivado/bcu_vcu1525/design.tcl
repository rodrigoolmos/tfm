...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins xdma_0/axi_aclk] [get_bd_pins axi_bram_features_ping/s_axi_aclk] [get_bd_pins axi_bram_features_pong/s_axi_aclk] [get_bd_pins axi_bram_prediction_ping/s_axi_aclk] [get_bd_pins axi_bram_prediction_pong/s_axi_aclk] [get_bd_pins predict_0/ap_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins xdma_0_axi_periph/ACLK] [get_bd_pins xdma_0_axi_periph/S00_ACLK] [get_bd_pins xdma_0_axi_periph/M00_ACLK]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins xdma_0/axi_aresetn] [get_bd_pins axi_bram_features_ping/s_axi_aresetn] [get_bd_pins axi_bram_features_pong/s_axi_aresetn] [get_bd_pins axi_bram_prediction_ping/s_axi_aresetn] [get_bd_pins axi_bram_prediction_pong/s_axi_aresetn] [get_bd_pins predict_0/ap_rst_n] [get_bd_pins axi_smc/aresetn] [get_bd_pins xdma_0_axi_periph/S00_ARESETN] [get_bd_pins xdma_0_axi_periph/M00_ARESETN] [get_bd_pins xdma_0_axi_periph/ARESETN]
